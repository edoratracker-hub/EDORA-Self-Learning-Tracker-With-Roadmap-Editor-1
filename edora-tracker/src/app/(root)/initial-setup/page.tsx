...
const STUDENT_EDUCATION_OPTIONS = [
  {
    ...
    description: "Currently in 10th-12th grade",
  },
  {
    id: "undergrad",
    label: "Undergraduate",
    description: "Bachelors degree in progress",
  },
  {
    id: "grad",
    label: "Graduate/Post-Grad",
    description: "Masters or higher in progress",
  },
  {
    id: "self_taught",
    label: "Self-Learner",
    description: "Learning outside formal education",
  },
];
...
const EXPERIENCE_LEVELS = [
  ...
  },
  {
    id: "projects",
    label: "Project Based",
    description: "Built some personal projects",
  },
  {
    id: "internship",
    label: "Internships",
    description: "Experienced professional setting",
  },
  {
    id: "pro",
    label: "Working Professional",
    description: "Currently employed or freelance",
  },
];
...
export default function InitialSetupPage() {
    ...
    try {
      ...
      if (role === "student") {
        result = await completeInitialSetup({
          ...
          programmingLanguages: formData.skills.filter((s: string) =>
            ["Python", "JavaScript", "TypeScript", "Node.js"].includes(s),
          ),
        ...
        result = await completeMentorInitialSetup({
          ...
          bio:
            formData.bio ||
            `Experienced ${formData.currentRole} in ${formData.industry}`,
        ...
        result = await completeProfessionalInitialSetup({
          ...
          bio:
            formData.bio ||
            `Professional ${formData.currentRole} focusing on ${formData.industry}`,
          yearsOfExperience: parseInt(formData.yearsOfExperience) || 0,
          industry: formData.industry,
          expertise: formData.skills,
          currentRole: formData.currentRole,
  ...
  useEffect(() => {
    if (showSuccess && currentRole === "student" && roleHome) {
      // Use push for navigation to allow dashboard to be in history
      router.push(roleHome);
    }
  }, [showSuccess, currentRole, router, roleHome]);
  ...
  if (showSuccess) {
    ...
    // For mentor/professional, show the success card
    return (
        ...
        >
          <Card className="">
            ...
            <CardContent className="space-y-4 pt-4">
              <Button onClick={() => router.push(roleHome)}>
                Enter Dashboard
                  ...
                  <div className="space-y-6">
                    <div className="space-y-2">
                      ...
                      <p className="text-sm text-muted-foreground mb-4">
                        This name will be visible on your profile and dashboard.
                      </p>
                      <Input
                        id="name"
                        autoFocus
                        ...
                        value={
                          role === "student" ? formData.name : formData.fullName
                        }
                        onChange={(e) => {
                        ...
                        <div className="space-y-4">
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              setFormData({
                                ...formData,
                                teachingProfession: e.target.value,
                              })
                            }
                          />
                        </div>
