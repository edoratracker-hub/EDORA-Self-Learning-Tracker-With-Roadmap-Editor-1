...
export function RoadmapContent() {
  ...
  const handleToggleTask = async (milestoneId: string, taskTitle: string, completed: boolean) => {
    ...
    setData(prev => {
      if (!prev) return prev;
      const newData = { ...prev };
      const categories: (keyof RoadmapData)[] = ['academic', 'skills', 'career'];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Student Roadmap</h1>
          ...
          <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="sm:max-w-[425px]">
              <DialogHeader>
                ...
                <DialogDescription>
                  Enter your goal (e.g., "Become a Web Developer" or "Score 90% in Finals").
