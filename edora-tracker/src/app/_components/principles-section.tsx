    ...
    const principles = [
        {
            number: "01",
            titleParts: [
                { text: "NO CONTENT", highlight: true },
                { text: " OVERLOAD", highlight: false },
            ],
            description: "EDORA does not host learning content. Instead, it helps you focus on what matters — structured learning with clear outcomes.",
            align: "left",
        },
        {
            number: "02",
            titleParts: [
                { text: "NO FAKE", highlight: true },
                { text: " PROGRESS", highlight: false },
            ],
            description: "Every milestone is validated. Track real consistency, effort, and growth — not just course completions.",
            align: "right",
        },
        {
            number: "03",
            titleParts: [
                { text: "NO UNSTRUCTURED ", highlight: false },
                { text: "LEARNING", highlight: true },
            ],
            description: "AI-generated roadmaps and mentor guidance ensure you have clarity and direction at every step.",
            align: "left",
        },
        {
            number: "04",
            ...
            description: "Build verifiable learning profiles backed by progress data — turning learning into measurable career growth.",
            align: "right",
        },
    ]
    ...
    return (
        <section ref={sectionRef} id="principles" className="relative py-32 pl-6 md:pl-28 pr-6 md:pr-12">
            ...
            <div ref={headerRef} className="mb-24">
                ...
                <h2 className="mt-4 font-[var(--font-bebas)] text-5xl md:text-7xl tracking-tight">EDORA IS NOT ANOTHER LEARNING PLATFORM</h2>
            </div>
