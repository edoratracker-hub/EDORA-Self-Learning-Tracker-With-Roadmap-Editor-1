...
const signals = [
    {
        date: "Feature 01",
        title: "AI-Generated Learning Roadmaps",
        note: "Personalized roadmaps created based on your goals, skill level, and time availability — focused on outcomes, not content overload.",
    },
    {
        date: "Feature 02",
        title: "Milestones, Progress & Badges",
        note: "Track milestones, maintain learning streaks, and earn badges that reflect real consistency and effort.",
    },
    {
        date: "Feature 03",
        title: "Mentor-Guided Validation",
        note: "Mentors review progress, provide guidance, and validate learning — ensuring accountability beyond AI suggestions.",
    },
    {
        date: "Feature 04",
        title: "Unified Learning Profile",
        note: "Your learning journey becomes a structured profile — similar to a resume — showcasing skills, achievements, and certifications.",
    },
]
    ...
    return (
        <section id="signals" ref={sectionRef} className="relative py-32 pl-6 md:pl-28">
            ...
            <div ref={headerRef} className="mb-16 pr-6 md:pr-12">
                ...
                <h2 className="mt-4 font-[var(--font-bebas)] text-5xl md:text-7xl tracking-tight">WHY EDORA</h2>
            </div>
