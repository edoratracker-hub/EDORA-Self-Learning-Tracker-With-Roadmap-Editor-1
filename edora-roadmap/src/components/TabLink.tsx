...
export function TabLink(props: TabLinkProps) {
  ...
  const className = cn(
    ...
    {
      'cursor-default border-b-white font-medium text-white': isActive,
      'border-b-transparent font-normal text-gray-400 hover:text-gray-300':
        !isActive,
      'font-medium hover:text-white text-gray-400 px-0': isExternal,
    },
    additionalClassName,
  );
