...
export function ProjectTabs(props: ProjectTabsProps) {
  ...
  return (
    <div className="my-3 flex flex-row flex-wrap items-center gap-1.5 overflow-hidden px-2.5 text-sm">
      <a
        href={`/${parentRoadmapId}/projects`}
        className={
          '-ml-1.5 flex items-center px-2 py-1.5 text-xs tracking-wide hover:text-black text-gray-500'
        }
      >
