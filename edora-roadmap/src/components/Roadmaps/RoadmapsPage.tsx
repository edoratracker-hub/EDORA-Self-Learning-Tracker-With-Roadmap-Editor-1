  ...
  return (
    <div className="">
      <button
        ...
        id="filter-button"
        className={cn(
          '-mt-1 flex w-full items-center justify-center py-2 text-sm text-white focus:shadow-none focus:outline-0 sm:hidden',
          {
            'mb-3': !isFilterOpen,
          },
        )}
      ...
      <div className="relative mx-auto flex max-w-4xl flex-col gap-4 sm:flex-row">
        <div
          className={cn(
            'hidden w-full flex-col sm:w-[180px] sm:bg-linear-to-l sm:pt-6',
            {
        ...
        >
          <div className="absolute top-0 -mx-4 w-full pb-0 shadow-xl sm:sticky sm:top-10 sm:mx-0 sm:bg-transparent sm:pb-20 sm:shadow-none">
